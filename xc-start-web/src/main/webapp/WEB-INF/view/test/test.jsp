...
<body>
<h1>所有的演示例子</h1>
<h3><a href="/dao?id=1">[url=./dao.do?id=1]Dao正常错误[/url]</a></h3>
<h3><a href="/dao?id=10">[url=./dao.do?id=10]Dao参数错误[/url]</a></h3>
<h3><a href="/dao?id=">[url=./dao.do?id=]Dao未知错误[/url]</a></h3>
